module Netcdf
  class NcAtt
    ...
    def initialize(@name, @ncid, @parent_id, @id)
      att_type = uninitialized Int32
      att_len = uninitialized UInt64
      Netcdf.call_netcdf { LibNetcdf4.nc_inq_att(@ncid, @parent_id, @name, pointerof(att_type), pointerof(att_len)) }
      @att_type = att_type
      @att_len = att_len
    end
    ...
    def value
      ...
      when LibNetcdf4::NC_USHORT
        ...
        @att_len == 1 ? ushort_val[0] : ushort_val
